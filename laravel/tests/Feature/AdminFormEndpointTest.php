...
{
    public function test_native_admin_forms_route_requires_super_admin(): void
    {
    ...
    public function test_native_admin_forms_route_matches_legacy_paginated_success_shape(): void
    {
    ...
    public function test_native_admin_forms_route_applies_query_string_filters(): void
    {
        ...
        $response = $this->withSession([
            ...
            'user_id' => 1,
            'role' => 'super_admin',
        ])->get('/api/admin/forms?page=2&per_page=5&search=safe&category_id=3&owner_id=7&sort_by=responses_desc');
